                        ...
                        @method('put')
                            <div class="card-body" id="inputs">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nom" value="{{ $enseignant->nom }}" id="nom" placeholder="Saisir nom de matiére">
                                    @error('nom')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="prenom" value="{{ $enseignant->prenom }}" id="prenom" placeholder="Saisir prenom de matiére">
                                    @error('prenom')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="email" value="{{ $enseignant->email }}" id="email" placeholder="Saisir email de matiére">
                                    @error('email')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="numtel" value="{{ $enseignant->numtel }}" id="numtel" placeholder="Saisir numtel de matiére">
                                    @error('numtel')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="date_naissance" value="{{ $enseignant->date_naissance }}" id="date_naissance" placeholder="Saisir date_naissance de matiére">
